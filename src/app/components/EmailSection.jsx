    ...
    <section id="contact" className="py-20">
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        >
          ...
          <div className="flex justify-center items-center space-x-2 text-gray-300 mb-8">
            <EnvelopeIcon className="h-6 w-6" />
            <span className="text-lg">grajpurohittt@gmail.com</span>
          </div>
          ...
          <div className="flex justify-center items-center space-x-6">
            <Link
              ...
              className="bg-white/5 hover:bg-white/10 p-3 rounded-md transition-all duration-300 transform hover:scale-110"
              aria-label="GitHub"
            >
