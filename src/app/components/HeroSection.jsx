...
const HeroSection = () => {
  return (
    <section>
      <div className="grid grid-cols-1 sm:grid-cols-12 gap-y-10">
        {/* Left Section */}
        <div className="col-span-7 place-self-center text-center sm:text-left">
          <h1 className="sm:text-5xl lg:text-6xl mb-3 text-6xl font-extrabold">
            ...
            <div
              ...
              style={{
                height: "2.6em", // Fixed height for smooth layout
              }}
            >
              <TypeAnimation
                sequence={[
          ...
          >
            <span className="block rounded-full px-6 py-2 font-semibold">
              Resume
            </span>
          </button>
        </div>
        ...
        {/* Right Section */}
        <div className="col-span-5 place-self-center flex flex-col items-center">
